...
public class SevenSpoons extends AppCompatActivity {
    ...
    ImageView spoonone, spoontwo, spoonthree, spoonfour, spoonfive, spoonsix, spoonseven;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seven_spoons);
        ...
        spoonseven = findViewById(R.id.spoonssiete);
        spoonseven.setImageResource(R.drawable.spoon);
        ...
        spoonone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent newIntent = new Intent(SevenSpoons.this, SixSpoons.class);
        ...
        spoonseven.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //For multiplayer, when all spoons are taken, then we move to the next game
                Intent newIntent = new Intent(SevenSpoons.this, SixSpoons.class);
